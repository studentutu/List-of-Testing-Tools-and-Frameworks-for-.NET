...
| [Kronikol](https://github.com/lemonlion/Kronikol) | - Auto-generates PlantUML/Mermaid sequence diagrams from integration and component tests by tracking HTTP traffic between services. Supports xUnit2/3, NUnit4, MSTest, LightBDD, BDDfy, ReqNRoll. Produces searchable HTML reports with embedded diagrams and YAML specs.<br>- Previously known as TestTrackingDiagrams
| [Meziantou.ShardedTest](https://github.com/meziantou/Meziantou.ShardedTest) | The tool runs a subset of tests from a test project based on the provided parameters on the CI/CD.
